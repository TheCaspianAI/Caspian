 ...
 * - PATH: Prepends ~/.caspian/bin so wrapper scripts intercept agent commands
 * - CASPIAN_PANE_ID: The pane ID (used by notification hooks, session key)
 * - CASPIAN_TAB_ID: The tab ID (parent of pane, used by notification hooks)
 * - CASPIAN_WORKSPACE_ID: The workspace ID (used by notification hooks)
 * - CASPIAN_WORKSPACE_NAME: The workspace name (used by setup/teardown scripts)
 * - CASPIAN_WORKSPACE_PATH: The worktree path (used by setup/teardown scripts)
 * - CASPIAN_ROOT_PATH: The main repo path (used by setup/teardown scripts)
