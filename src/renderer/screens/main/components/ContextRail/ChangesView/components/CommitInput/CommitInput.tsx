	...
	return (
		<div className="flex flex-col gap-2 px-3 py-2.5 border-b border-border">
			<Textarea
				...
				className="min-h-[52px] resize-none text-label bg-background border border-border shadow-none focus-visible:ring-1 focus-visible:ring-primary/20 focus-visible:border-primary/60"
				onKeyDown={(e) => {
