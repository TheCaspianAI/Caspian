...
export function ConnectionErrorOverlay({ onRetry }: ConnectionErrorOverlayProps) {
	return (
			...
			<Card className="gap-3 py-4 px-2 max-w-xs">
				<div className="flex flex-col items-center text-center gap-1.5 px-4">
					...
					<div className="space-y-0.5">
						...
						<p className="text-xs text-muted-foreground">Lost connection to terminal daemon</p>
					</div>
				</div>
				<div className="px-4">
