...
const ALLOWED_PREFIXES = [
	"CASPIAN_", // Our own metadata vars
	"LC_", // Locale settings
];
 ...
 * This prevents Caspian app secrets and build-time config from leaking to terminals.
 *
...
export function buildTerminalEnv(params: {
	...
	const terminalEnv: Record<string, string> = {
		...baseEnv,
		...shellEnv,
		TERM_PROGRAM: "Caspian",
		TERM_PROGRAM_VERSION: process.env.npm_package_version || "1.0.0",
		COLORTERM: "truecolor",
		LANG: locale,
		CASPIAN_PANE_ID: paneId,
		CASPIAN_TAB_ID: tabId,
		CASPIAN_WORKSPACE_ID: workspaceId,
		CASPIAN_WORKSPACE_NAME: workspaceName || "",
		CASPIAN_WORKSPACE_PATH: workspacePath || "",
