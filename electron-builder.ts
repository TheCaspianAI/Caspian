...
const config: Configuration = {
	...
	mac: {
		...
		extendInfo: {
			...
			NSLocalNetworkUsageDescription:
				"Caspian needs access to your local network to discover and connect to development servers running on your network.",
	...
	linux: {
		...
		target: ["AppImage", "deb"],
		artifactName: `caspian-\${version}-\${arch}.\${ext}`,
	},
